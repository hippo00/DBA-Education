    ...
    >
      ...
      <div class="banner__btns">
        ...
        <div class="banner__search">
          <input placeholder="Please leave us your comment on Slack #csp-DBA-Education-feedback. Thank you" v-model="comment" :class="{ open: isCommentOpen }" @keyup.enter="submitComment" readonly/>
...
export default {
  ...
  methods: {
    ...
    submitComment () {
      ...
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/comment`, {
        route,
        comment
      }).then(response => {
      })
    ...
    submitLike () {
      ...
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/add_likes`, {
        route,
        amount: 1
      })
    },
    submitDislike () {
      ...
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/add_dislikes`, {
        route,
        amount: 1
      })
    },
    ...
    getLikes () {
      let route = this.$router.currentRoute.path
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/likes`, {
        route
      }).then(response => {
    ...
    getDislikes () {
      let route = this.$router.currentRoute.path
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/dislikes`, {
        route
      }).then(response => {
    ...
    initialize (path) {
      ...
      let route = this.$router.currentRoute.path
      axios.post(`https://dba-support-DBA-Education-api.mybluemix.net/visit`, {
        route
      }).then(response => {})
