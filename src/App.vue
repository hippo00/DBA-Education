  ...
  <div id="app">
    ...
    <main>
      ...
      <div class="container" v-else>
        ...
        <h1 class="results__heading" v-else-if="!content">Loading...</h1>
...
export default {
  ...
  data () {
    return {
      baseUrl: 'https://pages.github.ibm.com/hippo00/DBA-Education',
      isNavOpen: false,
  ...
  methods: {
    ...
    search ($event) {
      if (this.searchKeywords && this.content && this.searchIndex) {
        ...
        if (this.searchKeywords.indexOf('topic:') > -1) {
          ...
          const searchResults = this.searchIndex.search(this.searchKeywords, {
            fields: {
              name: {
                boost: 4
              },
          ...
          for (let i = 0; i < searchResults.length; i++) {
            searchResults[i] = {
              ...this.searchIndex.documentStore.getDoc(searchResults[i].ref),
              ...searchResults[i]
            }
          }
